...
from sudocode_close_on_merge import (  # noqa: E402
    SudocodeCliGateway,
    default_sudocode_db_path,
    resolve_shared_sudocode_dir,
)
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Sudocode DB path (default: shared repo .sudocode/cache.db)",
    )
    parser.add_argument(
        "--once",
        action="store_true",
