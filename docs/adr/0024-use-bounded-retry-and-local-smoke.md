# ADR-0024: use bounded retry and local smoke
...
- 재평가 이슈: `i-5m9o`
- 근거 문서: `docs/reports/2026-W09-alerting-retry-and-smoke-reassessment.md`
- 판정: 기본 재시도 상한(2회, 총 3회 시도) 유지, 로컬 스모크 기본 유지 + 실환경 전송 스모크는 보완 절차로 운용
- ADR 충돌 여부: 없음 (후속 ADR 즉시 발행 불필요)
